...
var s =
    $.ajax({
        ...
        success: function(data) {
            document.getElementById('result2').innerHTML = data; // Выведет содержимое файла в консоль
        }
    });
console.log(s)
